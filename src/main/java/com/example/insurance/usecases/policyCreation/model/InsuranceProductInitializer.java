...
public class InsuranceProductInitializer {
        ...
        private void createProducts() {
                ...
                InsuranceCategory propertyCategory = categoryRepository.findByName("Property")
        ...
        private InsuranceProduct createAutoInsurance(InsuranceCategory category) {
                ...
                calcConfig.setFormula("base + (ageFactor * driverAge) + (valueFactor * vehicleValue)");
        ...
        private InsuranceProduct createLifeInsurance(InsuranceCategory category) {
                ...
                // "ageFactor", 15.0,
                // "healthFactor", 200.0));
                calcConfig.setFormula("base + (ageFactor * insuredAge) + (healthFactor * riskLevel)");
