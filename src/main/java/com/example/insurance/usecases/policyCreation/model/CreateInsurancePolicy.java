...
public class CreateInsurancePolicy {
    ...
    @ElementCollection
    @CollectionTable(name = "policy_target_audience", joinColumns = @JoinColumn(name = "policy_id"))
    @Column(name = "audience")
    private List<String> targetAudience;

    @ElementCollection
    @CollectionTable(name = "policy_region", joinColumns = @JoinColumn(name = "policy_id"))
    @Column(name = "region")
