...
// @Service
// public class PremiumCalculationServiceImpl implements
...
// PremiumCalculationConfig config = product.getCalculationConfig();
// if (config == null) {
// throw new IllegalArgumentException("No calculation config found for product:
// " + product.getId());
// }
...
// // Apply formula-based calculation if specified
// if (config.getFormula() != null) {
// calculatedAmount = applyFormula(config.getFormula(), calculatedAmount,
// config.getFactors(), riskFactors);
// }
...
// if (config.getCommissionRate() != null) {
// calculatedAmount =
// calculatedAmount.multiply(BigDecimal.ONE.add(config.getCommissionRate()));
// }
...
// }
// } catch (Exception e) {
// System.err.println("Error processing risk factor " + key + ": " +
// e.getMessage());
// }
// }
...
// return result;
// } catch (Exception e) {
// System.err.println("Error evaluating formula: " + formula + ", error: " +
// e.getMessage());
// System.err.println("Falling back to base amount: " + baseAmount);
// return baseAmount;
// }
...
// private BigDecimal evaluateExpression(String expression, Map<String,
...
// private BigDecimal getAgeMultiplier(int age,
// List<PremiumCalculationConfig.AgeBracket> ageBrackets) {
// if (ageBrackets == null || ageBrackets.isEmpty()) {
// return BigDecimal.ONE;
// }
// for (PremiumCalculationConfig.AgeBracket bracket : ageBrackets) {
// if (age >= bracket.getMinAge() && age <= bracket.getMaxAge()) {
// return bracket.getMultiplier() != null ? bracket.getMultiplier() :
// bracket.getFactor();
// }
// }
// return BigDecimal.ONE;
