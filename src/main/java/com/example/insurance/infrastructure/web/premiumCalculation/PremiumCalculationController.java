...
// insuranceProductRepository.findById(request.getProductId())
...
// if (product.getProductType().name().equals(ProductType.AUTO)) {
// request.getRiskFactors().put("driverAge", userAge);
// }
// // For Life insurance, also add insuredAge
// else if (product.getProductType().name().equals(ProductType.LIFE)) {
// request.getRiskFactors().put("insuredAge", userAge);
// }

// MonetaryAmount calculatePremium =
// premiumCalculationService.calculatePremium(product,
// request.getRiskFactors());

// // calculate installment amount based on payment frequency
// BigDecimal installmentAmount =
// calculateInstallmentAmount(calculatePremium.getAmount(),
// request.getPaymentFrequency());

// return new PremiumCalculationResponse(calculatePremium.getAmount(),
// calculatePremium.getCurrency(), installmentAmount,
// request.getPaymentFrequency(),
// product.getCalculationConfig().getFormula());
// }

// private BigDecimal calculateInstallmentAmount(BigDecimal totalAnnualAmmount,
...
// case "MONTHLY":
// return totalAnnualAmmount.divide(BigDecimal.valueOf(12), 2,
// RoundingMode.HALF_UP);
// case "QUARTERLY":
// return totalAnnualAmmount.divide(BigDecimal.valueOf(4), 2,
// RoundingMode.HALF_UP);
// case "ANNUAL":
// return totalAnnualAmmount;
// default:
